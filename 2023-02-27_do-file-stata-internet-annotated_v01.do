***********************************************************************************************************************************************************
***SYNTAX FOR "Sex and socio-economic inequalities in the breadth of internet use before and during the COVID-19 pandemic among older adults in England"***
***********************************************************************************************************************************************************
...
* Check participant counts in each category
tab frequency
tab frequency if wave==9
tab frequency if wave==10
...
* Keep if internet data are not missing at Wave 9
keep if emails0!=.
* Count total number of participants
unique idauniq
* 4,054 individuals 
* Pearson's chi-squared test at Wave 9 (differences between male and female participants)
tab SexTV0 emails0, chi
tab SexTV0 calls0, chi
tab SexTV0 health0, chi
tab SexTV0 enter0, chi
tab SexTV0 news0, chi 
tab SexTV0 market0, chi 
tab SexTV0 social0, chi 
tab SexTV0 transa0, chi 
clear
* Use LCAwidenamescov.dta dataset
use LCAwidenamescov.dta
* Keep if internet data are not missing at COVID Wave 1
keep if emails1!=.
* Count total number of participants
unique idauniq
* 3,908 individuals 
* Pearson's chi-squared test at COVID Wave 1 (differences between male and female participants)
tab SexTV1 emails1, chi
tab SexTV1 calls1, chi
tab SexTV1 health1, chi
tab SexTV1 enter1, chi
tab SexTV1 news1, chi 
tab SexTV1 market1, chi 
tab SexTV1 social1, chi 
tab SexTV1 transa1, chi 
clear
